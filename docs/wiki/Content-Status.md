...
| Groupes Tok'ra | Profils internes `Combat` et `Peaceful` réutilisés par la présence mondiale masquée et les incidents Tok'ra ; premier cache médical de cellule cachée ajouté | 0.1.41-dev / présence 0.2.7-dev / cache 0.2.12-dev |
