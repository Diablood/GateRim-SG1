...
La version `0.3.95-dev` finalise les objets de mission Tok'ra : module de
chiffrement d'introduction, paquet de renseignements codés, dispositif
d'observation portable et point déployé, cache organique, nœud de contrôle du
relais Goa'uld, communicateur sécurisé et marquage prioritaire de livraison.
Les Defs, sauvegardes et comportements de mission restent inchangés.
