...
| Contact de planque Tok'ra | Contact pacifique non marchand dans les planques cachées, échange unique via clic droit, +1 confiance Tok'ra, briefing médical dont l'XP varie selon le palier de confiance et indice médical narratif adapté à la confiance | 0.2.18-dev / dialogue 0.2.20-dev / briefing 0.2.21-dev / paliers 0.2.22-dev / indices 0.2.23-dev |
