...
> Dernière révision : `0.3.89-dev`
> Révision locale à valider : `r1`
>

Cette page distingue les fonctionnalités déjà disponibles du contenu encore en préparation.

La version `0.3.89-dev` prépare les six icônes finales des gènes de gameplay,
supprime l'ancien prototype `SG1_JaffaLongevity`, classe les quatre icônes de
factions mondiales comme finales et complète la galerie wiki des sept sites
d'événements déjà validés. La longévité des Jaffa reste fournie par le Prim'ta ;
aucun effet actif, comportement de faction ou site mondial n'est modifié.
...
| Audit des assets visuels | Registre maintenu à 608 PNG / 75 familles ; `About/ModIcon.png` reste final hors compteur et 21 familles locales sont finales ; contrôle automatique et [page de référence progressive](Visual-Assets) | 0.3.85-dev / mises à jour 0.3.86-dev, 0.3.88-dev et 0.3.89-dev |
