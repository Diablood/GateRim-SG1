...
| Communicateur sécurisé Tok'ra | Bâtiment alimenté ouvrant un canal au palier fiable ; demandes opérées par un colon : débriefing opérationnel, diversion défensive, soutien médical, cache médicale, évaluation tactique et rapport d'état RP avec posture de confiance et libellés verrouillés simplifiés | 0.2.26-dev à 0.2.34-dev |
