...
| Fondation générique de missions | Boîte à outils pilotée par Defs pour phases, objectifs, banques de textes nommées, récurrence contextuelle, difficulté et persistance ; l'observation et la récupération de renseignements lisent leurs données depuis XML, tandis que leurs interactions RimWorld spécialisées restent en C# | 0.3.23-dev à 0.3.25-dev |
