...
| Fondation générique de missions | Boîte à outils pilotée par Defs pour phases, objectifs, banques de textes nommées, récurrence contextuelle, difficulté et persistance ; l'observation, la récupération de renseignements et l'accueil de l'agent blessé lisent leurs données depuis XML, tandis que leurs interactions RimWorld spécialisées restent en C# | 0.3.23-dev à 0.3.26-dev |
