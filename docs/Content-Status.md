...
| Opérations Tok'ra organiques | Opportunités récurrentes à slot unique, délai caché, anti-répétition et difficulté adaptative : huit archétypes intégrés, dont appels de détresse, contrats de production, diversion Goa'uld/Jaffa et capture vivante d'un officier Jaffa ; les nouvelles offres exigent un communicateur joueur alimenté | 0.2.48-dev à 0.3.37-dev / accès 0.3.33-dev |
