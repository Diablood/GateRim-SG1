...
Dernier jalon publié : `0.3.46-dev - Add Goa'uld world-name generators`. Les nouveaux mondes génèrent des noms propres pour chaque domaine Goa'uld et des colonies dédiées, sans renommer les sauvegardes existantes.
> Statut : Implémenté
...
| Opérations Tok'ra organiques | Opportunités récurrentes à slot unique, délai caché, anti-répétition et difficulté adaptative : huit archétypes intégrés ; l'audit `0.3.38-dev` vérifie automatiquement leur couverture persistante, leurs variantes RP et l'efficacité de la pénalité de répétition | 0.2.48-dev à 0.3.38-dev / accès 0.3.33-dev |
...
| Outils de capture non létaux | Bolas à usage unique fabricables et fusil hypodermique expérimental Tok'ra actuellement réglé à douze charges non rechargeables ; impact contondant très léger et neutralisation temporaire résistible | 0.3.36-dev / réserve ajustée 0.3.37-dev |
| Capture Tok'ra d'un officier Jaffa | Mission récurrente validée : site mondial, cible vivante, escorte adaptative, reformation vanilla sans lit local, retour en cellule, nettoyage du site, appel depuis le communicateur et équipe Tok'ra visible qui emporte le prisonnier avant la réussite | 0.3.37-dev |
...
| Variantes du treillis SG | Deux déclinaisons purement visuelles : treillis noir pour les missions tactiques et treillis désert pour les environnements arides ; caractéristiques identiques au treillis olive | 0.1.82-dev |
| Scénario Équipe SG isolée | Premier départ jouable sans Porte fonctionnelle : faction expédition du SGC dédiée, quatre adultes capables de se battre, équipement SG, armes vanilla temporaires, sacs de couchage, ravitaillement et introduction narrative | 0.2.0-dev-r1 |
