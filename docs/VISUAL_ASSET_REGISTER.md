...
1. The free Goa'uld, Tok'ra and queen symbiote forms still share one mobile-pawn
...
| `Things/Item/Equipment/WeaponRanged/SG1_Bolas` | 1 | 128×128 | Map/item/pawn | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
| `Things/Item/Equipment/WeaponRanged/SG1_MatokStaff` | 1 | 128×128 | Map/item/pawn | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
...
| `Things/Item/Equipment/WeaponRanged/SG1_ZatnikTel` | 1 | 128×128 | Map/item/pawn | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
...
| `Things/Pawn/Animal/SG1_GoauldSymbiote/SG1_GoauldSymbiote` | 1 | 128×128 | Map/item/pawn | `temporary-reuse` | `P1` | Registered runtime reference | Registered temporary family. |
...
| `Things/Pawn/Humanlike/Apparel/JaffaDeployedHelmet/JaffaDeployedHelmet` | 5 | 128×128 | Map/item/pawn | `temporary-original` | `P1` | Registered runtime reference | Registered temporary family. |
| `Things/Pawn/Humanlike/Apparel/JaffaGauntlets/JaffaGauntlets` | 29 | 128×128 | Map/item/pawn | `temporary-original` | `P1` | Registered runtime reference | Registered temporary family. |
| `Things/Pawn/Humanlike/Apparel/JaffaHeavyArmor/JaffaHeavyArmor` | 29 | 128×128 | Map/item/pawn | `temporary-original` | `P1` | Registered runtime reference | Registered temporary family. |
| `Things/Pawn/Humanlike/Apparel/JaffaLightArmor/JaffaLightArmor` | 29 | 128×128 | Map/item/pawn | `temporary-original` | `P1` | Registered runtime reference | Registered temporary family. |
| `Things/Pawn/Humanlike/Apparel/JaffaOfficerArmor/JaffaOfficerArmor` | 29 | 128×128 | Map/item/pawn | `temporary-recolor` | `P1` | Registered runtime reference | Registered temporary family. |
| `Things/Pawn/Humanlike/Apparel/JaffaOfficerDeployedHelmet/JaffaOfficerDeployedHelmet` | 5 | 128×128 | Map/item/pawn | `temporary-recolor` | `P1` | Registered runtime reference | Registered temporary family. |
...
| `Things/Pawn/Humanlike/Apparel/JaffaReinforcedBoots/JaffaReinforcedBoots` | 29 | 128×128 | Map/item/pawn | `temporary-original` | `P1` | Registered runtime reference | Registered temporary family. |
...
| `Things/Projectile/SG1_BolasProjectile` | 1 | variable | Projectile | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
| `Things/Projectile/SG1_MatokBlast` | 1 | variable | Projectile | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
| `Things/Projectile/SG1_TokraHypodermicDart` | 1 | variable | Projectile | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
| `Things/Projectile/SG1_ZatnikTelBlast` | 1 | variable | Projectile | `temporary-original` | `P2` | Registered runtime reference | Registered temporary family. |
