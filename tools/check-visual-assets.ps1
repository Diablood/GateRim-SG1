...
$wikiIconMappings = @(
    ...
    (New-WikiMapping "Textures/Things/Pawn/Animal/SG1_AdultSymbiote/SG1_AdultSymbiote_east.png" "docs/wiki/images/SG1_AdultSymbiote_east.png" "docs/wiki/Symbiotes.md" "images/SG1_AdultSymbiote_east.png"),
    (New-WikiMapping "Textures/Things/Pawn/Animal/SG1_AdultSymbiote/SG1_AdultSymbiote_north.png" "docs/wiki/images/SG1_AdultSymbiote_north.png" "docs/wiki/Symbiotes.md" "images/SG1_AdultSymbiote_north.png"),
    (New-WikiMapping "Textures/Things/Pawn/Animal/SG1_AdultSymbiote/SG1_AdultSymbiote_south.png" "docs/wiki/images/SG1_AdultSymbiote_south.png" "docs/wiki/Symbiotes.md" "images/SG1_AdultSymbiote_south.png"),
    (New-WikiMapping "Textures/Things/Pawn/Animal/SG1_GoauldQueen/SG1_GoauldQueen_east.png" "docs/wiki/images/SG1_GoauldQueen_east.png" "docs/wiki/Goauld-Queen-Assisted-Maturation.md" "images/SG1_GoauldQueen_east.png"),
    (New-WikiMapping "Textures/Things/Pawn/Animal/SG1_GoauldQueen/SG1_GoauldQueen_north.png" "docs/wiki/images/SG1_GoauldQueen_north.png" "docs/wiki/Symbiotes.md" "images/SG1_GoauldQueen_north.png"),
    (New-WikiMapping "Textures/Things/Pawn/Animal/SG1_GoauldQueen/SG1_GoauldQueen_south.png" "docs/wiki/images/SG1_GoauldQueen_south.png" "docs/wiki/Symbiotes.md" "images/SG1_GoauldQueen_south.png"),
